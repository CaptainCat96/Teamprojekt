...
public class FensterSpiel extends JFrame {
	...
	public FensterSpiel() {
		...
		gbl_contentPane.rowHeights = new int[] { 25, 39, 61, 23, 24, 23, 14, 0, 0 };
		...
		gbc_txtWelchesWortIst.insets = new Insets(0, 0, 5, 5);
		...
		gbc_btnStreet.insets = new Insets(0, 0, 5, 5);
		...
		gbc_FragenVerbleibend.insets = new Insets(0, 0, 5, 5);
		...
		lblNameLerneinheit = new JLabel("New label");
		GridBagConstraints gbc_lblNameLerneinheit = new GridBagConstraints();
		gbc_lblNameLerneinheit.gridwidth = 3;
		gbc_lblNameLerneinheit.insets = new Insets(0, 0, 0, 5);
		gbc_lblNameLerneinheit.gridx = 1;
		gbc_lblNameLerneinheit.gridy = 7;
		contentPane.add(lblNameLerneinheit, gbc_lblNameLerneinheit);
	}
}
