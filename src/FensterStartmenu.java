...
public class FensterStartmenu extends javax.swing.JFrame {
	 ...
	 * Aufgabe 1
	 */
	public void LadeListeLerneinheiten() {
		
	}
	/**
	 * Create the frame.
	 */
	public FensterStartmenu() {
		/**
		 * Logik
		 */
			LadeListeLerneinheiten();
		...
		setDefaultCloseOperation(FensterStartmenu.EXIT_ON_CLOSE);
		...
		AuswahlLerneinheit = new JComboBox();
